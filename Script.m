...
lines = readlines("timing.txt");

samplePeriod = 1/str2double(lines(1));
...
title('Gyroscope');
legend('X', 'Y', 'Z');
saveas(gcf,'/Users/sharan/PycharmProjects/Flask_Webpage/static/Gyroscope.png');
...
legend('X', 'Y', 'Z');
saveas(gcf,'/Users/sharan/PycharmProjects/Flask_Webpage/static/Tilt-compensated_accelerometer.png');
...
legend('X', 'Y', 'Z');
saveas(gcf,'/Users/sharan/PycharmProjects/Flask_Webpage/static/Linear_acceleration.png');
...
legend('X', 'Y', 'Z');
saveas(gcf,'/Users/sharan/PycharmProjects/Flask_Webpage/static/Linear_Velocity.png');
...
legend('X', 'Y', 'Z');
saveas(gcf,'/Users/sharan/PycharmProjects/Flask_Webpage/static/High-pass_filtered_Linear_Velocity.png');
...
legend('X', 'Y', 'Z');
saveas(gcf,'/Users/sharan/PycharmProjects/Flask_Webpage/static/Linear_position.png');
...
legend('X', 'Y', 'Z');
saveas(gcf,'/Users/sharan/PycharmProjects/Flask_Webpage/static/High-pass_filtered_linear_position.png');
...
total_time = (index_of_last - release_sample)*samplePeriod;

%Flight time calc
flight_time = (index(3)-release_sample)*samplePeriod
hold on;
plot(locs,pks,"o");
xlabel("Samples");
ylabel("Peak");
...
datatable = readtable('variables.xlsx');  %or true if there is a header
numRows = height(datatable) + 1

filename = 'variables.xlsx';
filename2 = 'params.txt';
column_names = {'Ball No.','Flight time(s)', 'Avergae speed(m\s)','Spin X(rps)', 'Spin Y(rps)', 'Spin Z(rps)', 'Release speed(Rs)', 'Release angle(Alpha)','Release angle(Beta)','Release angle(Gamma)', 'Speed after Pitch(Rp)', 'Pitch Angle(Alpha)','Pitch Angle(Beta)','Pitch Angle(Gamma)', 'Total Time(s)'};
data = {numRows,flight_time, avspeed,S,resrs,tetrs,resap,tetap, total_time};
